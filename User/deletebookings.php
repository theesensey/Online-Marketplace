            ...
            <table id="providers" class="table">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<a href='?delete_id=" . $row['id'] . "' onClick='return confirm(\"Are you sure you want to delete this booking?\")'>Delete</a>"; // changed the text and message of confirmation box
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
